...
public class TransactionController {
    ...
    @PostMapping(value = {
            ...
            "/admin/user/add-transaction/{userId}",
            "/admin/user/add-transaction/{userId}/{subuserId}",
    ...
    public ResponseEntity<ApiResponse<AddTransactionResponseDto>> addTransaction(@AuthenticationPrincipal User user,
        ...
        verifier.checkAccountExistence(requestDto.getAccountId());


        AddTransactionResponseDto newTransaction = transactionService.addTransaction(user,userId,subuserId,requestDto,file);
